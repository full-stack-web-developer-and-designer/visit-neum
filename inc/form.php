...
<h4 id="response" class="success"><!-- This will hold response from the server --></h4>
        <fieldset>
            <legend>Vaši podaci</legend>
					<div class="form-control InputIconBg"><input type="text" class="input username" name="name" id="name" placeholder="Vaše ime i prezime..." value="<?php if (isset($_POST['name'])) {echo htmlentities($_POST['name']);} ?>"><i class="fas fa-user" aria-hidden="true"></i><span class="error"><?=$name_error; ?></span></div><!-- end .form-control -->
					...
					<div class="form-control InputIconBg"><input type="text" class="input mail" name="email" id="email" placeholder="Vaš e-mail..." value="<?php if (isset($_POST['email'])) {echo htmlentities($_POST['email']);}?>" autocomplete="off"><i class="fas fa-envelope" aria-hidden="true"></i><span class="error"><?=$email_error;?></span></div><!-- end .form-control -->
					<div class="form-control InputIconBg"><textarea maxlength="500" name="message" class="textinput message" cols="46" rows="8" id="message" placeholder="Vaša poruka..."><?php if (isset($_POST['message'])) {echo htmlentities($_POST['message']);} ?></textarea><i class="fas fa-pencil-alt" aria-hidden="true"></i><span class="error"><?= $message_error; ?></span></div><!-- end .form-control -->
			   </fieldset>
