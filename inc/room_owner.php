...
<h4 id="responseOwner" class="success"><!-- This will hold response from the server --></h4>
  <fieldset>
    <legend>Vaši podaci</legend>
		...
		<div class="form-control halb InputIconBg"><input minlength="9" type="tel" class="input phone" name="tel" placeholder="Vaš broj telefona..." value="<?php echo Input::get('tel'); ?>"><i class="fas fa-phone-alt" aria-hidden="true"></i><span class="error"><?=$tel_error; ?></span></div><!-- end .form-control -->
		...
		<div class="form-control single InputIconBg"><input type="email" class="input mail" name="userMail" placeholder="Vaš e-mail..." value="<?php echo Input::get('userMail'); ?>"><i id="" class="fas fa-envelope owner_icon" aria-hidden="true"></i><span class="error"><?=$userMail_error; ?></span></div><!-- end .form-control --> 
